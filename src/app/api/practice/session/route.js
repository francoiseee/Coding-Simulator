...
export async function POST(request) {
  ...
  if (insertError) {
    // Previously swallowed entirely — logging now so a real failure (RLS
    // rejection, constraint violation, stale auth) is diagnosable from the
    // server terminal instead of only ever showing the generic message below.
    console.error("coding_sessions insert failed:", {
